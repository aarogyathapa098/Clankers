        ...
        <div className="dashboard-content">
          <header className="page-header" style={{ marginBottom: 16, display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
            ...
            <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
              ...
              <button className="btn" style={{ background: '#000', color: '#fff', border: 'none', display: 'flex', alignItems: 'center', gap: '8px' }}>
                <span style={{ fontSize: '14px' }}>⚲</span> RULESETS
              </button>
            </div>
          </header>

          <section className="panel" style={{ marginBottom: 24, borderTop: '2px solid #000' }}>
            ...
            <div style={{ display: 'flex', gap: '16px', alignItems: 'flex-end' }}>
              <div>
                ...
                <div style={{ display: 'flex' }}>
                  {['MON', 'TUE', 'WED', 'THU', 'FRI'].map(d => (
                    <button key={d} className={`btn ${d === 'TUE' ? 'primary' : ''}`} style={{ padding: '8px 16px', fontSize: '12px', borderRadius: 0, margin: 0, borderRight: d !== 'FRI' ? 'none' : '', background: d === 'TUE' ? '#000' : '#fff', color: d === 'TUE' ? '#fff' : '#000', fontWeight: 'bold' }}>{d}</button>
                  ))}
                </div>
              </div>
              <div style={{ flex: 1 }}>
              ...
              <button className="btn primary" style={{ height: '38px', background: '#000', color: '#fff', border: 'none', fontWeight: 'bold', padding: '0 24px' }}>+ FIND</button>
            </div>
          </section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 1fr', gap: '16px', marginBottom: '24px' }}>
             <div className="panel" style={{ padding: '16px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
               ...
               <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                 ...
                 <div style={{ fontSize: '10px', border: '1px solid #cbd5e1', padding: '2px 6px', borderRadius: '2px' }}>ALGO</div>
               </div>
             </div>
             ...
             <div className="panel" style={{ padding: '16px', display: 'flex', alignItems: 'center', gap: '16px' }}>
               ...
               <div className="muted" style={{ fontSize: '10px', fontWeight: 'bold', lineHeight: 1.2 }}>
                 ...
                 <span style={{ color: '#000' }}>66.7% OCCUPIED</span>
               </div>
             </div>
             <div className="panel" style={{ padding: '16px', borderLeft: '4px solid #000', display: 'flex', alignItems: 'center', gap: '16px' }}>
               <div style={{ fontSize: '40px', fontWeight: 'bold' }}>14</div>
               <div className="muted" style={{ fontSize: '10px', fontWeight: 'bold', lineHeight: 1.2 }}>
                 AVAILABLE VACANCY<br/>
                 <span style={{ background: '#000', color: '#fff', padding: '2px 4px', display: 'inline-block', marginTop: '4px' }}>33.3% FREE</span>
               </div>
             </div>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '320px 1fr', gap: '24px' }}>
            <div className="stack" style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '2px solid #000', paddingBottom: '8px' }}>
                ...
                <div style={{ fontSize: '10px', background: '#e2e8f0', padding: '2px 6px', fontWeight: 'bold' }}>14 QUALIFIED</div>
              </div>
              
              {mockRooms.filter(r => r.status === 'available').map(room => (
                <div key={room.id} className="panel" style={{ padding: '16px', border: room.id === 'R404' ? '2px solid #000' : '1px solid var(--card-border)' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px', alignItems: 'flex-start' }}>
                    <div>
                      <strong style={{ fontSize: '14px' }}>{room.name}</strong> <span style={{ fontSize: '9px', border: '1px solid #cbd5e1', padding: '2px 4px', borderRadius: '2px', fontWeight: 'bold' }}>{room.type}</span>
                      {room.id === 'R404' && <span style={{ fontSize: '9px', background: '#000', color: '#fff', padding: '2px 4px', marginLeft: '4px', borderRadius: '2px', fontWeight: 'bold' }}>SELECTED</span>}
                    </div>
                    <span style={{ fontSize: '10px', border: '1px solid #000', padding: '2px 6px', fontWeight: 'bold' }}>[ FREE NOW ]</span>
                  </div>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    <button className="btn" style={{ fontSize: '10px', padding: '6px 12px', background: room.id === 'R404' ? '#000' : '#fff', color: room.id === 'R404' ? '#fff' : '#000', fontWeight: 'bold', border: room.id === 'R404' ? 'none' : '1px solid #000' }}>[ QUICK BOOK / ASSIGN ]</button>
                  </div>
                </div>
              ))}
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              <div className="panel" style={{ padding: 0, overflow: 'hidden' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '12px 16px', borderBottom: '2px solid #000', background: '#f8fafc' }}>
                  ...
                  <div style={{ fontSize: '10px', display: 'flex', gap: '12px', alignItems: 'center' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}><span style={{ color: '#000' }}>●</span> OCCUPIED</div>
                  ...
                  <table style={{ width: '100%', textAlign: 'center', borderCollapse: 'collapse' }}>
                    <thead>
                      <tr style={{ borderBottom: '1px solid #000', background: '#fff' }}>
                        ...
                        <th style={{ padding: '12px', background: '#000', color: '#fff', borderRight: '1px solid var(--card-border)', fontSize: '10px' }}>11:00 (TARGET)</th>
                        <th style={{ padding: '12px', fontSize: '10px' }}>12:30</th>
                      </tr>
                    </thead>
                    <tbody>
                      {mockRooms.map(room => (
                        <tr key={room.id} style={{ borderBottom: '1px solid var(--card-border)', background: '#fff' }}>
                          ...
                          <td style={{ padding: '8px', borderRight: '1px solid var(--card-border)' }}>
                            {room.status === 'occupied' ? (
                              <div style={{ background: '#000', color: '#fff', padding: '8px 4px', borderRadius: '2px', fontSize: '10px', fontWeight: 'bold' }}>CS101<br/>Sec A</div>
                            ) : (
                          ...
                          <td style={{ padding: '8px', borderRight: '1px solid var(--card-border)' }}>
                            {room.status === 'occupied' ? (
                              ...
                              <div style={{ background: '#000', color: '#fff', padding: '8px 4px', borderRadius: '2px', fontSize: '10px', fontWeight: 'bold' }}>SE302<br/>Terminals</div>
                            ) : (
                              <div style={{ color: '#94a3b8', fontSize: '10px', padding: '12px' }}>[FREE]</div>
                            )}
                          </td>
                          <td style={{ padding: '8px', borderRight: '1px solid var(--card-border)' }}>
                            {room.status === 'available' ? (
                              <div style={{ border: '1px solid #000', color: '#000', padding: '12px', borderRadius: '2px', fontSize: '10px', fontWeight: 'bold' }}>[FREE]<br/>Open</div>
                            ) : (
                              <div style={{ background: '#ef4444', color: '#fff', padding: '8px 4px', borderRadius: '2px', fontSize: '10px', fontWeight: 'bold' }}>⚠ CLASH ( 2 SEC )<br/>MA101 / MA104</div>
                            )}
                          </td>
                          <td style={{ padding: '8px' }}>
                            {room.id === 'R404' ? (
                              <div style={{ background: '#000', color: '#fff', padding: '8px 4px', borderRadius: '2px', fontSize: '10px', fontWeight: 'bold' }}>CS204<br/>Lab Tut</div>
                            ) : (
                              <div style={{ color: '#94a3b8', fontSize: '10px', padding: '12px' }}>[FREE]</div>
                            )}
                          </td>
              ...
              <div style={{ borderLeft: '4px solid #ef4444', background: '#fff', padding: '16px', borderTop: '1px solid #e2e8f0', borderRight: '1px solid #e2e8f0', borderBottom: '1px solid #e2e8f0', borderRadius: '0 4px 4px 0' }}>
              ...
              <div style={{ borderLeft: '4px solid #000', background: '#fff', padding: '16px', borderTop: '1px solid #e2e8f0', borderRight: '1px solid #e2e8f0', borderBottom: '1px solid #e2e8f0', borderRadius: '0 4px 4px 0' }}>
                ...
                <div style={{ paddingLeft: '18px', display: 'flex', gap: '8px' }}>
                  <button className="btn" style={{ background: '#000', color: '#fff', fontSize: '10px', fontWeight: 'bold', padding: '6px 16px', border: 'none' }}>CONFIRM ASSIGNMENT</button>
