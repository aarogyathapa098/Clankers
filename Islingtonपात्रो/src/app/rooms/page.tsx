        ...
        <div className="dashboard-content">
          <header className="page-header" style={{ marginBottom: 16, display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
            ...
            <div style={{ display: 'flex', gap: '8px' }}>
              ...
              <button className="btn primary" style={{ background: '#000', color: '#fff', border: 'none' }}>+ REGISTER NEW ROOM</button>
            </div>
          </header>

          <div className="grid stats-grid" style={{ marginBottom: 24, display: 'flex', gap: '16px' }}>
            <div className="panel" style={{ flex: 1, padding: '16px', borderLeft: '4px solid #000', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            ...
            <div className="panel" style={{ flex: 1.5, padding: '16px', borderTop: '4px solid #10b981', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
              ...
              <div style={{ fontSize: '10px', color: '#64748b', marginTop: '8px', borderTop: '1px solid #eee', paddingTop: '8px', display: 'flex', justifyContent: 'space-between' }}>
                <span>OCCUPANCY:</span>
                <span style={{ fontWeight: 'bold', color: '#000' }}>74.2% AV</span>
              </div>
            </div>
          </div>
          ...
          <div className="panel" style={{ marginBottom: '24px', padding: '16px', borderTop: '1px solid #e2e8f0', display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div style={{ display: 'flex', gap: '8px' }}>
                <button className="btn" style={{ background: '#000', color: '#fff', fontSize: '10px', padding: '4px 12px', borderRadius: '4px', border: 'none' }}>ALL (42)</button>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 320px', gap: '24px' }}>
            <section className="panel" style={{ padding: 0, overflow: 'hidden' }}>
                  ...
                  <tbody>
                    {mockRooms.map(room => (
                      <tr key={room.id} style={{ borderBottom: '1px solid var(--card-border)', background: room.id === 'R401' ? '#f1f5f9' : '#fff' }}>
                        ...
                        <td style={{ padding: '16px 12px' }}>
                          <span style={{ fontSize: '10px', border: '1px solid #cbd5e1', padding: '4px 8px', borderRadius: '2px', fontWeight: 'bold' }}>{room.type}</span>
                        </td>
                        ...
                        <td style={{ padding: '16px 12px' }}>
                          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                            ...
                            <div className="progress" style={{ width: '80px', height: '6px', background: '#e2e8f0', borderRadius: '2px', overflow: 'hidden' }}>
              ...
              <div style={{ padding: '12px 16px', background: '#f8fafc', borderTop: '1px solid #e2e8f0', fontSize: '10px', color: '#94a3b8', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div>SHOWING 1 - 7 OF 42 FACILITY RECORDS</div>
                <div style={{ display: 'flex', gap: '4px' }}>
                  <button className="btn" style={{ padding: '2px 6px', fontSize: '10px' }}>&lt;&lt; PREV</button>
                  <button className="btn" style={{ padding: '2px 8px', fontSize: '10px', background: '#000', color: '#fff', border: 'none' }}>1</button>
            ...
            <aside style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              <div className="panel" style={{ border: '2px solid #000' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '16px' }}>
                  <div className="muted" style={{ fontSize: '10px', fontWeight: 'bold' }}>// SELECTED ROOM PROFILE</div>
                  <div style={{ border: '1px solid #000', fontSize: '9px', fontWeight: 'bold', padding: '2px 4px' }}>LIVE METADATA</div>
                </div>
                ...
                <div style={{ border: '1px dashed #cbd5e1', height: '120px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '16px', background: '#f8fafc', color: '#94a3b8', fontSize: '10px', textAlign: 'center', padding: '16px' }}>
                  ARCHITECTURAL SCHEMATIC - DWG: 104<br/>(Floor Plan CAD Ref: FP-B-401-v2)
                </div>

                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px', marginBottom: '24px' }}>
                  <div style={{ border: '1px solid var(--card-border)', padding: '12px', borderRadius: '4px', background: '#fff' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', marginBottom: '24px' }}>
                  <div style={{ border: '1px solid #e2e8f0', padding: '8px', fontSize: '10px', display: 'flex', justifyContent: 'space-between', background: '#f8fafc' }}>
                ...
                <div style={{ display: 'flex', gap: '8px' }}>
                  <button className="btn" style={{ background: '#000', color: '#fff', fontSize: '10px', fontWeight: 'bold', border: 'none', padding: '12px', flex: 1 }}>RESERVE ROOM SLOT</button>
